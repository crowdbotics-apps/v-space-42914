"""
Django settings for v_space_42914 project.
...
ROOT_URLCONF = 'v_space_42914.urls'
...
WSGI_APPLICATION = 'v_space_42914.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "v_space_42914 API",
    "DESCRIPTION": "API documentation for v_space_42914 App",
    "VERSION": "v1",
}
